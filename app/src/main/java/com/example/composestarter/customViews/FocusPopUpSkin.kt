...
@Composable
fun FocusPopUpSkin(
    model: ChromasItemUIModel,
    onDismissRequest: () -> Unit,
    watchtPreviewVideo: (ChromasItemUIModel) -> Unit,
    addToMyFavorite: (ChromasItemUIModel) -> Unit,
) {
        ...
        Surface(
            ...
            Column(
                ...
                Card(
                    ...
                    loadImage(
                        url = model.displayIcon.toString(),
                    ...
                    Column {
                        Row(
                            Modifier
                                ...
                                .clickable {
                                    onDismissRequest()
                                    watchtPreviewVideo(model)
                                }) {
                            Spacer(modifier = Modifier.width(15.dp))
                            Text(
                                text = stringResource(id = R.string.watch_preview_video),
                                modifier = Modifier
